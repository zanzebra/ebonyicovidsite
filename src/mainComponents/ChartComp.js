...
class ChartComponent extends React.Component {
  ...
  render() {
    const renderChart = this.state.daysData;
    let render;
    if (renderChart === []) {
      render = <h2>There is no data to dispaly for this month</h2>;
    } else {
      render = (
        <Line
          className="linechart"
            ...
            <ul className="menu">
              <li>
                <span className="cases">
                  <span className="cases-data">107</span>
                </span>
                <span>Confirmed Casas</span>
              </li>
              <li>
          ...
          <div id="content">
            <section className="charts">
              <div className="container-fluid">
                <div className="chart-container">{render}</div>
              </div>
            </section>
          </div>
        </div>
